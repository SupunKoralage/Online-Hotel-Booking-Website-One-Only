...
function Validate()
{
	if(validateCheck_In()&& validateEmail()&&validateCard_Name() && validateCard_No()&& validateExpire())
	{
...
<body>
	<form id="form1" name="form1" method="post" action="AddTable.php">
	<header>
	...
	<div class="reserve">
		...
		<form method="post" id="reserve" action="">
			...
			<label>Date:</label><br>
			<input type="datetime-local" name="date1" id="date1" ><br><br>
